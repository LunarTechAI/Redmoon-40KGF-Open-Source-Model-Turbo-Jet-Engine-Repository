...
This document catalogs all major components of the Redmoon 40KGF turbojet engine, with sketches, images, and concise functional explanations. For theory, safety, and detailed analysis, see the reference PDFs in `DOCS/REFERENCE/`.
...
- Attribution: Redmoon 40KGF Project
